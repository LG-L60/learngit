...
MTK6572M_LCM_LIB_PATH := $(LK_TOP_DIR)/mtk6572m_lk_lcm_lib
MTK6572M_LCM_LIB_NAME := $(LK_TOP_DIR)/mtk6572m_lk_lcm_lib/libmt6572m_lcm_lk.a
endif
...
ifeq ($(BUILD_SEC_LIB),yes)
	...
	@echo linking $@
ifeq ($(MTK6572M_LCM_PATCH),yes)
	$(NOECHO)$(LD) $(LDFLAGS) -T $(LINKER_SCRIPT) $(OUTPUT_TZ_BIN) $(ALLOBJS) $(LIBGCC) $(LIBSEC) $(LIBSEC_PLAT) -L $(MTK6572M_LCM_LIB_PATH) $(MTK6572M_LCM_LIB_NAME) -o $@
else
...
ifeq ($(BUILD_SEC_LIB),yes)
	...
	@echo linking $@
ifeq ($(MTK6572M_LCM_PATCH),yes)
	$(NOECHO)$(LD) $(LDFLAGS) -T $(LINKER_SCRIPT)  $(ALLOBJS) $(LIBGCC) $(LIBSEC) $(LIBSEC_PLAT) -L $(MTK6572M_LCM_LIB_PATH) $(MTK6572M_LCM_LIB_NAME) -o $@
else
