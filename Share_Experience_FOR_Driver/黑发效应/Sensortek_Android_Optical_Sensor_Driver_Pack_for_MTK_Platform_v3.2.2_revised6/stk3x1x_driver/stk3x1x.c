...
#include "stk3x1x.h"
#define DRIVER_VERSION          "3.2.2 v6"
...
#else						
	obj->ps_high_thd_boot = obj->ps_stat_data[1] + STK_HT_N_CT*2;
	obj->ps_low_thd_boot = obj->ps_stat_data[1] + STK_LT_N_CT*2;
	atomic_set(&obj->ps_high_thd_val, obj->ps_high_thd_boot); 
	atomic_set(&obj->ps_low_thd_val, obj->ps_low_thd_boot); 
#endif
...
static int stk_ps_tune_zero_init(struct stk3x1x_priv *obj)
{
	...
	{
		obj->ps_high_thd_boot = STK_HT_N_CT*3;
		obj->ps_low_thd_boot = STK_LT_N_CT*3;
	}
#endif
